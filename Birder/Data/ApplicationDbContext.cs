...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<ConservationStatus>().HasData(new ConservationStatus
        {
            ...
            Description =
                "Red is the highest conservation priority, with these species needing urgent action.  Species are placed on the Red-list if they meet one or more of the following criteria: are globally important, have declined historically, show recent severe decline, and have failed to recover from historic decline.",
        ...
        builder.Entity<ConservationStatus>().HasData(new ConservationStatus
        {
            ...
            Description =
                "Species on the green list are the least critical group.  These are species that occur regularly in the UK but do not qualify under the Red or Amber criteria.",
            CreationDate = new DateTime(2021, 2, 16, 21, 18, 37, 756, DateTimeKind.Local).AddTicks(2143),
            LastUpdateDate = new DateTime(2021, 2, 16, 21, 18, 37, 756, DateTimeKind.Local).AddTicks(2143)
        });
        ...
        builder.Entity<ConservationStatus>().HasData(new ConservationStatus
        {
            ...
            Description =
                "This is species is a former breeder and was not was not assessed in the UK Birds of Conservation Concern 4.",
            CreationDate = new DateTime(2021, 2, 16, 21, 18, 37, 756, DateTimeKind.Local).AddTicks(2143),
            LastUpdateDate = new DateTime(2021, 2, 16, 21, 18, 37, 756, DateTimeKind.Local).AddTicks(2143)
        });
